package com.eigenbaumarkt.spring5_mongodb_reactive_recipe_app.bootstrap;
...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    public void onApplicationEvent(ContextRefreshedEvent event) {
        ...
        log.error("####################################");
        log.error("Units of Measure in its reactive repository after loading bootstrap data: " +
